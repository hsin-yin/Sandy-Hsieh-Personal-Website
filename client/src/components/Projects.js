...
const Projects = () => {
    const projectsData = [
        ...
        },
        {
            ...
            content: 'Students can search and register for classes they want to take, and teachers can offer classes for students to register for.',
        ...
        },
        {
            ...
            content: 'A website that offers customized cookie gift boxes, where you can choose the flavor of the cookies and arrange them to your liking, which will be displayed on the screen.',
        ...
        },
        {
            ...
            content: 'A static site consisting of multiple pages. Includes restaurant menu, contact information, location.',
